...
const api = {
  ...
  exportFolder: (ids: number[], folders: string[] = []): Promise<boolean> => ipcRenderer.invoke('export:folder', ids, folders),
  exportZip: (ids: number[], folders: string[] = []): Promise<boolean> => ipcRenderer.invoke('export:zip', ids, folders),
